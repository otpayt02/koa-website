...
function getDraftSecret() {
	return "751cc591-d743-40bc-a411-570eaf71e74f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "0997f004-0cda-46a6-ae4e-73db115cf64a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "0997f004-0cda-46a6-ae4e-73db115cf64a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "0997f004-0cda-46a6-ae4e-73db115cf64a",
		rootBoundaryId
	});
}
/**
