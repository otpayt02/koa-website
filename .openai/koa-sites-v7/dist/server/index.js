...
function getDraftSecret() {
	return "2e25a7b8-1936-4053-afe1-97cf972da176";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b9e33551-3667-4d0c-b00f-19a939682c7d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b9e33551-3667-4d0c-b00f-19a939682c7d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b9e33551-3667-4d0c-b00f-19a939682c7d",
		rootBoundaryId
	});
}
/**
