...
export default async function AboutPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <>
    ...
    <section id="impact"><TabImageGallery tab="impact" /><div className="full-bleed-cta"><img src="/koa/assets/koa-national-community-ai.jpg" alt="A Karen community gathering" loading="lazy" decoding="async" /><div><p className="eyebrow">Annual reporting</p><h2>Transparency belongs to everyone.</h2><p>KOA&apos;s first public digital annual report will bring program outcomes, partnerships, and financial stewardship into one accessible view.</p><Button href={`/${lang}/changelog`}>See public decisions</Button></div></div></section>
  </>;
}
