...
var client_references_default = {
	"01c723869d37": async () => {
		const m = await import("./assets/DonationForm-BSjMxplw.js");
		return { get "DonationForm"() {
			return m["DonationForm"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-qE-vDLXx.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"3823713893bf": async () => {
		const m = await import("./assets/CommunityAtmosphere-DYlZPThw.js");
		return { get "CommunityAtmosphere"() {
			return m["CommunityAtmosphere"];
		} };
	},
	"3cd5cc60e79b": async () => {
		const m = await import("./assets/DictionarySearch-xlJSvMAY.js");
		return { get "DictionarySearch"() {
			return m["DictionarySearch"];
		} };
	},
	"3ea3fb182115": async () => {
		const m = await import("./assets/AudioPlayer-d7WmuI91.js").then((n) => n.n);
		return { get "AudioPlayer"() {
			return m["AudioPlayer"];
		} };
	},
	"4282d4ce3fc5": async () => {
		const m = await import("./assets/DesignStudio-CLd0OkR8.js");
		return { get "DesignStudio"() {
			return m["DesignStudio"];
		} };
	},
	"54f30265b4a6": async () => {
		const m = await import("./assets/FormStatus-BBQiJ5ck.js");
		return { get "AsyncForm"() {
			return m["AsyncForm"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DYXIIxOW.js");
		return {
			get "ErrorBoundary"() {
	...
	"5f500422bfe4": async () => {
		const m = await import("./assets/CinematicLanding-EUDquYKT.js");
		return { get "CinematicLanding"() {
			return m["CinematicLanding"];
		} };
	},
	"6bd20bf2b9da": async () => {
		const m = await import("./assets/LanguageStudio-BMywnWWU.js");
		return { get "LanguageStudio"() {
			return m["LanguageStudio"];
		} };
	},
	"8c0f216c4604": async () => {
	...
	"a70590210833": async () => {
		const m = await import("./assets/Header-D_mS4c1J.js");
		return { get "Header"() {
			return m["Header"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-DiLTuv2w.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"dbc017c018fa": async () => {
		const m = await import("./assets/CursorGlareImage-BpMR_jEQ.js");
		return { get "CursorGlareImage"() {
			return m["CursorGlareImage"];
		} };
	},
	"f65e369fbb19": async () => {
		const m = await import("./assets/AudioRecorder-CmbInNHm.js");
		return { get "AudioRecorder"() {
			return m["AudioRecorder"];
		} };
	}
};
//#endregion
